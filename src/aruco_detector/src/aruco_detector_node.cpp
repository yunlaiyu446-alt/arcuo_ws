...
public:
    ArucoDetectorNode() : Node("aruco_detector_node")
    {
        ...
        this->declare_parameter<bool>("publish_empty_markers", true);
        ...
        publish_empty_markers_ = this->get_parameter("publish_empty_markers").as_bool();
...
private:
    ...
    void image_callback(const sensor_msgs::msg::Image::SharedPtr msg) 
    {
        ...
        try {
            ...
            if (!markers_msg.markers.empty() || publish_empty_markers_) {
                markers_publisher_->publish(markers_msg);
                RCLCPP_DEBUG(this->get_logger(), "Published %zu markers.", markers_msg.markers.size());
            }
